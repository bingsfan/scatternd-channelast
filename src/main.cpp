...
int main(int argc, char *argv[]) {
    ...
    time_test_scatter("3x2x1-1 channellast test", []() {
        test_scatterND3x2x1channellast(
            {4, 4, 48}, {768, 3}, {768},
            "input/3_2_1_data48/input_data-channellast16.txt",
            "input/3_2_1_data48/myindices.txt",
            "input/3_2_1_data48/updates.txt",
            "input/3_2_1_data48/myoutput-mychan16.txt",
            0, 16);
    });
#endif
#if 1
    time_test_scatter("3x2x1-2 channellast test", []() {
        test_scatterND3x2x1channellast(
            ...
            "input/3_2_1_data48_8/output-mychan16.txt",
            0, 16);
    });
#endif
#if 1
    time_test_scatter("3x3x3 channellast test", []() {
        test_scatterND3x3x3channellast(
            ...
            "input/3_3_3_data1_32/myoutput-channellast16.txt",
            0, 16);
    });
#endif
